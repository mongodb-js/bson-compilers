  ...
  describe('castTo', () => {
    ...
    it('does not cast numeric', () => {
      ...
      expect(compiler.start(str)).to.equal(
        'TestFunc(new java.lang.Long(\"10\"), new java.lang.Double(10.01), 0x6, 05)'
      );
    });
    it('casts long, dec, hex, octal, and Number to long', () => {
      ...
      expect(compiler.start(str)).to.equal(
        'TestFunc(new java.lang.Long(\"10\"), new java.lang.Long(10.01), new java.lang.Long(0x6), new java.lang.Long(0o5), new java.lang.Long(\"99\"))'
      );
    });
